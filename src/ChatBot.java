public class ChatBot {
    ...
    // shares music taste and asks about yours
    public void music() {
        System.out.println("I like to listen to electronic music, what about you?");
    }

    // returns the bot's favorite number to the power of the favorite number
    public double ultimateFavoriteNumber() {
